...
class User(UserMixin, Model):
    ...
    course = CharField()
    image_file = BlobField(default="default.jpg")
    ...
    @classmethod
    def create_user(cls, username, email, role, password, event_assigned=False, image_file="http://s3.amazonaws.com/37assets/svn/765-default-avatar.png", course="General"):
        try:
            cls.create(
                username=username,
                email=email,
